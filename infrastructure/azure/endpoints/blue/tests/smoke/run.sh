...
# ============================================================
#  Smoke test for Azure ML Online Endpoint (Blue deployment)
# ============================================================
...
# Files to test
FILES=(
  "infrastructure/azure/endpoints/blue/tests/smoke/payload.json"
  "infrastructure/azure/endpoints/blue/samples/serving_input_example.json"
)
